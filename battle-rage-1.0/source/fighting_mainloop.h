...
#ifndef BATTLE_RAGE_FIGHTING_MAINLOOP_HH
#define BATTLE_RAGE_FIGHTING_MAINLOOP_HH
...
extern int8_t fighting_mainloop(Fighters* fighter1, Fighters* fighter2, int8_t round) ;
