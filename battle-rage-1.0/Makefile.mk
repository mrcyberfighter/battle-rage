...
pkgdatadir  = $(datarootdir)/battle-rage
...
WARNS = $(WALL) -Wall -Wextra -pedantic -Wc++11-compat

CXXFLAGS   += -std=c++11 -g -O2 -finline-functions -fno-signed-zeros

CPPFLAGS   =

LDFLAGS = `pkg-config --cflags sdl2` `pkg-config --cflags SDL2_image` `pkg-config --cflags SDL2_ttf` `pkg-config --cflags SDL2_mixer`
LDLIBS  = `pkg-config --libs sdl2` `pkg-config --libs SDL2_image` `pkg-config --libs SDL2_ttf` `pkg-config --libs SDL2_mixer` -lm
...
SRC_FILES = $(SRC_DIR)/global_vars.cpp \
            $(SRC_DIR)/global_fighters.cpp \
            $(SRC_DIR)/Files/draw_rect.cpp \
            $(SRC_DIR)/Files/images_utils.cpp \
            $(SRC_DIR)/Files/ttf_utils.cpp \
            $(SRC_DIR)/Files/SDL2_utils.cpp \
            $(SRC_DIR)/Fighters/Fighters.cpp \
            $(SRC_DIR)/Fighters/Fuuma.cpp \
            $(SRC_DIR)/Fighters/Geese_Howard.cpp \
            $(SRC_DIR)/Fighters/Hanzo.cpp \
            $(SRC_DIR)/Fighters/Hotaru_Futaba.cpp \
            $(SRC_DIR)/Fighters/Iori_Yagami.cpp \
            $(SRC_DIR)/Fighters/K.cpp \
            $(SRC_DIR)/Fighters/Kim_Kaphwan.cpp \
            $(SRC_DIR)/Fighters/Kisarah_Westfield.cpp \
            $(SRC_DIR)/Fighters/Kyo_Kusanagi.cpp \
            $(SRC_DIR)/Fighters/Lee_Pai_Long.cpp \
            $(SRC_DIR)/Fighters/Mai_Shiranui.cpp \
            $(SRC_DIR)/Fighters/Mr_Big.cpp \
            $(SRC_DIR)/Fighters/Mr_Karate.cpp \
            $(SRC_DIR)/Fighters/Robert_Garcia.cpp \
            $(SRC_DIR)/Fighters/Rock_Howard.cpp \
            $(SRC_DIR)/Fighters/Terry_Bogard.cpp \
            $(SRC_DIR)/Input_Handler.cpp \
            $(SRC_DIR)/joystick.cpp \
            $(SRC_DIR)/helper_functions.cpp \
            $(SRC_DIR)/main.cpp \
            $(SRC_DIR)/joystick_configuration.cpp \
            $(SRC_DIR)/choose_fighters.cpp \
            $(SRC_DIR)/fighting_mainloop.cpp \
            $(SRC_DIR)/presentation_screen.cpp \
            $(SRC_DIR)/main_menu.cpp \
            $(SRC_DIR)/configure_game_menu.cpp \
            $(SRC_DIR)/round_interlude.cpp
